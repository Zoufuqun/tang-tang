...
public class GeneralCodeApplication {
    ...
    private static void generalMybatisFile() {
        // 代码生成器
...
//        mpg.setTemplateEngine(new FreemarkerTemplateEngine());
    ...
    private static void selfConfig(AutoGenerator mpg, String projectPath, PackageConfig pc) {
...
//        pc.setModuleName(scanner("模块名"));
    ...
    private static String globalConfig(AutoGenerator mpg) {
        ...
        String projectPath = System.getProperty("user.dir") + "/men-spring/men-spring-generate-mybatis-service";
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("zoufuqun");
        gc.setOpen(false);
